...
$(BUILD_DIR)/constants.o : ../Source/constants.f90 
	@echo "Compiling object file" $@ "from"  $< 
	@$(FC) $(FCFLAGS) $(LDFLAGS) -o $@ -c $<
$(BUILD_DIR)/state.o : ../Source/state.f90 $(BUILD_DIR)/density.o $(BUILD_DIR)/memory.o $(BUILD_DIR)/trace.o $(BUILD_DIR)/pot.o $(BUILD_DIR)/wave.o $(BUILD_DIR)/basis.o $(BUILD_DIR)/io.o $(BUILD_DIR)/comms.serial.o $(BUILD_DIR)/units.o $(BUILD_DIR)/constants.o 
	@echo "Compiling object file" $@ "from"  $< 
	@$(FC) $(FCFLAGS) $(LDFLAGS) -o $@ -c $<
